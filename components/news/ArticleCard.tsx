...
export default function ArticleCard({
  ...
  return (
    <Card>
      <Link href={{ pathname: "/news/[slug]", params: { slug: article.slug } }} className="flex flex-col h-full">
        <div className="relative aspect-[16/10]">
          {article.coverImageUrl ? (
            <Image src={article.coverImageUrl} alt="" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover transition-transform duration-500 group-hover:scale-105" />
          ) : (
