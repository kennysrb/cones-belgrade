    ...
    <footer className="mt-24 border-t border-surface-700/60 bg-surface-900">
      <div className="mx-auto max-w-container px-6 py-16 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-surface-200 text-sm leading-relaxed">{tF("tagline")}</p>
        </div>
        <div>
          <p className="font-heading text-xs uppercase tracking-[0.25em] text-cones-blue mb-3">{tF("quickLinks")}</p>
        ...
        <div>
          <p className="font-heading text-xs uppercase tracking-[0.25em] text-cones-blue mb-3">{tF("contact")}</p>
          <p className="text-sm text-surface-200">{tF("address")}</p>
          <p className="mt-2 text-sm text-surface-200">hello@cones.rs</p>
        </div>
        <div>
          <p className="font-heading text-xs uppercase tracking-[0.25em] text-cones-blue mb-3">{tF("follow")}</p>
          <ul className="space-y-2 text-sm">
